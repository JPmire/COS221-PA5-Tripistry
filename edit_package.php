                        ...
                        <div id="acc-dest" class="p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 max-h-[250px] overflow-y-auto">
                            ...
                            <?php else: ?>
                                <?php foreach ($destinations as $dest): ?>
                                    ...
                                    <div class="flex items-center justify-between p-2 border border-outline-variant rounded hover:bg-background-light group <?php echo $checked ? 'border-primary/50 bg-primary/5' : ''; ?>">
                                ...
                                <?php foreach ($attractions as $attr): ?>
                                    ...
                                    <div class="flex items-center justify-between p-2 border border-outline-variant rounded hover:bg-background-light group <?php echo $checked ? 'border-primary/50 bg-primary/5' : ''; ?>">
                                        <label class="flex items-start gap-2.5 cursor-pointer select-none flex-grow">
                                            ...
                                            <span class="text-xs font-medium text-text-main leading-tight attr-label">
                                ...
                                <?php foreach ($restaurants as $rest): ?>
                                    ...
                                    <div class="flex items-center justify-between p-2 border border-outline-variant rounded hover:bg-background-light group <?php echo $checked ? 'border-primary/50 bg-primary/5' : ''; ?>">
                                        <label class="flex items-start gap-2.5 cursor-pointer select-none flex-grow">
                                            ...
                                            <span class="text-xs font-medium text-text-main leading-tight rest-label">
